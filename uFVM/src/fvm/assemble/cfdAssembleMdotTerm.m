function theFluxes = cfdAssembleMdotTerm(theEquationName,theTerm)
%--------------------------------------------------------------------------
%
...
theFluxes = cfdAssembleMdotTermInterior;

% Assemble mdot_f at boundary faces
theFluxes = cfdAssembleMdotTermBoundary(theFluxes,theEquationName,theTerm);

% Fix Pressure if Needed
theFluxes = cfdAssembleMdotTermFixPressure(theFluxes);

% used to update the mdot field
...
% INTERIOR Assembly
%===================================================
function theFluxes = cfdAssembleMdotTermInterior
...
if isTransient
    theDensityFieldOld = cfdGetMeshField('rho_Ueq', 'Elements', 'Step1');
    ...
    vel_old_bar_f = cfdInterpolateFromElementsToFaces('Average', theVelocityFieldOld.phi);
    vel_old_bar_f = vel_old_bar_f(iFaces,:);
    
    U_old_bar_f = (dot(vel_old_bar_f(:,:)',Sf(:,:)'))';
    
    theMdotFieldOld = cfdGetMeshField('mdot_f', 'Faces', 'Step1');
...
if strcmp(applicationClass, 'compressible')
    ...
    if isTransient
        ...
        FLUXTE = (rho(iElements) - rho_old(iElements)) .* volume(iElements) / deltaT;
    end
end
...
function theFluxes = cfdAssembleMdotTermBoundary(theFluxes,theEquationName,theTerm)
...
for iPatch=1:theNumberOfPatches
    ...
    if strcmp(thePhysicalType,'wall')
        if strcmp(theBCType,'noSlip')
            theFluxes =  cfdAssembleMdotTermWallNoslipBC(iPatch,theFluxes,theEquationName,theTerm);
        elseif strcmp(theBCType,'slip')
            theFluxes =  cfdAssembleMdotTermWallSlipBC(iPatch,theFluxes,theEquationName,theTerm);
        elseif strcmp(theBCType,'zeroGradient')
            theFluxes =  cfdAssembleMdotTermWallZeroGradientBC(iPatch,theFluxes,theEquationName,theTerm);
        else
    ...
    elseif strcmp(thePhysicalType,'inlet')
        if strcmp(theBCType,'inlet') || strcmp(theBCType,'zeroGradient')
            theFluxes =  cfdAssembleMdotTermInletInletBC(iPatch,theFluxes,theEquationName,theTerm);
        elseif(strcmp(theBCType,'Supersonic Inlet'))
            theFluxes =  cfdAssembleMdotTermInletSupersonicInletBC(iPatch,theFluxes,theEquationName,theTerm);
        elseif strcmp(theBCType,'fixedValue')
            theFluxes =  cfdAssembleMdotTermInletFixedValueBC(iPatch,theFluxes,theEquationName,theTerm);
        else
            error([theBCType '<<<< not implemented']);
        end
        %
    ...
    elseif strcmp(thePhysicalType,'outlet')
        if strcmp(theBCType,'outlet')
            theFluxes =  cfdAssembleMdotTermOutletOutletBC(iPatch,theFluxes,theEquationName,theTerm);
        elseif strcmp(theBCType,'fixedValue')
            theFluxes =  cfdAssembleMdotTermOutletFixedValueBC(iPatch,theFluxes,theEquationName,theTerm);
        else
            error([theBCType '<<<< not implemented']);
        end
        %
...
%===================================================
function theFluxes =  cfdAssembleMdotTermWallSlipBC(iPatch,theFluxes,theEquationName,theTerm)
...
%===================================================
function theFluxes =  cfdAssembleMdotTermWallNoslipBC(iPatch,theFluxes,theEquationName,theTerm)
...
%===================================================
function theFluxes =  cfdAssembleMdotTermWallZeroGradientBC(iPatch,theFluxes,theEquationName,theTerm)
...
%===================================================
function theFluxes =  cfdAssembleMdotTermInletInletBC(iPatch,theFluxes,theEquationName,theTerm)
...
%===================================================
function theFluxes =  cfdAssembleMdotTermInletSupersonicInletBC(iPatch,theFluxes,theEquationName,theTerm)
%
theMesh = cfdGetMesh;
%
theBoundary = theMesh.boundaries(iPatch);
...
%===================================================
function theFluxes =  cfdAssembleMdotTermInletFixedValueBC(iPatch,theFluxes,theEquationName,theTerm)
...
function theFluxes =  cfdAssembleMdotTermInletSpecifiedAveragePressureBC(iPatch,theFluxes,theEquationName,theTerm)
...
function theFluxes =  cfdAssembleMdotTermOutletOutletBC(iPatch,theFluxes,theEquationName,theTerm)
...
function theFluxes =  cfdAssembleMdotTermOutletFixedValueBC(iPatch,theFluxes,theEquationName,theTerm)
%
theMesh = cfdGetMesh;
%
theBoundary = theMesh.boundaries(iPatch);
